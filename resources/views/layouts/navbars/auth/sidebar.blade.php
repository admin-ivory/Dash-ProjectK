  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 text-danger ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Managements</h6>
      </li>
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('show-bus-list') ? 'active' : '') }}" href="{{ url('show-bus-list') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                <i style="font-size: 1rem;" class="fas fa-lg fa-list-ul ps-2 pe-2 text-center text-dark {{ (Request::is('show-bus-list') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
            </div>
            <span class="nav-link-text ms-1">Comp Management</span>
        </a>
      </li>
      <li class="nav-item pb-2 ">
        <div class="dropright">
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
              <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center"> 
              <i style="font-size: 1rem;" class="ni ni-air-baloon ps-2 pe-2 text-center text-dark {{ (Request::is('') ? 'text-white' : 'text-dark') }} " aria-hidden="true"></i>
              </div>
              <span class="nav-link-text ms-1">User Management</span>
            </a>
            <div class="dropdown-menu">
                <a href="#" class="dropdown-item">All Users</a>
                <a href="#" class="dropdown-item">Active Users</a>
                <a href="#" class="dropdown-item">Email To All</a>
            </div>
        </div>
      </li>
      <li class="nav-item pb-2 ">
        <div class="dropright">
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
              ...
              <span class="nav-link-text ms-1">Bookings Management</span>
            </a>
            <div class="dropdown-menu">
                <a href="#" class="dropdown-item">All Bookings</a>
                <a href="#" class="dropdown-item">Pending Ticket</a>
                <a href="#" class="dropdown-item">Booked Ticket</a>
                <a href="#" class="dropdown-item">Rejected Ticket</a>
            </div>
        </div>
      </li>
      <li class="nav-item mt-2">
        <h6 class="ps-4 text-danger ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Road</h6>
      </li>
      <li class="nav-item">
      <div class="dropright">
            <a href="#" class="dropdown-toggle nav-link" data-bs-toggle="dropdown">
              ...
              <span class="nav-link-text ms-1">Road Management</span>
            </a>
            <div class="dropdown-menu">
                <a href="#" class="dropdown-item">All Road</a>
                <a href="#" class="dropdown-item">Scheduling</a>
                <a href="#" class="dropdown-item">Ticket Price</a>
                <a href="#" class="dropdown-item">Trip</a>
                <a href="#" class="dropdown-item">Assigned Vehicule</a>
            </div>
        </div>
      </li>
      <li class="nav-item mt-2">
        <h6 class="ps-4 text-danger ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Manage Booking</h6>
      </li>
      <li class="nav-item">
      ...
      <li class="nav-item mt-3">
        <h6 class="ps-4 text-danger ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Seetings</h6>
      </li>
      <li class="nav-item">
